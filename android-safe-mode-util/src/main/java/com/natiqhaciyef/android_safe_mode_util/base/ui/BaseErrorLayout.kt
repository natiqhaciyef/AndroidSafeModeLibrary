...
import com.natiqhaciyef.android_safe_mode_util.R
...
import com.natiqhaciyef.android_safe_mode_util.databinding.BaseErrorLayoutBinding
        ...
        binding?.apply {
            ...
            if (description != EMPTY_STRING)
                errorDescription.text =
                    ctx.getString(R.string.files_loading_error_description_result)
